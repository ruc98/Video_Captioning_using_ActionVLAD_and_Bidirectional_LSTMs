...
Original file is located at
    https://colab.research.google.com/drive/1bI-VxT6ZlaT-P5uhL1vXcykjYlyfR9iO
"""
...
!cp /gdrive/'My Drive'/npcap.npy npcap.npy

!python3 train.py

!cp /content/sim_vgg.pth /gdrive/'My Drive'
...
su=np.zeros(shape=(vlad.shape[0]))
nu=np.zeros(shape=(vlad.shape[0]))
su1=0
j=0
...
for epoch in range(1):  # again, normally you would NOT do 300 epochs, it is toy data
    ...
    for i in range(70,100,1):
        for j in range(5):
            ...
            cap_pred = model(cap_target,features[i])
            hypothesis.append(calc(cap_pred))
            #print(calc(cap_pred))
            #print(" ".join(sentence))
            #print(calc(cap_pred))
...
np.save('npcap_16',vlad)

!cp /content/npcap_16.npy /gdrive/'My Drive'
...
np.save('npcap_8',vlad)

!cp /content/npcap_8.npy /gdrive/'My Drive'
